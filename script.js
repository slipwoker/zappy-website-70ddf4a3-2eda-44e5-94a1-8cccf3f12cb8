document.addEventListener('DOMContentLoaded', function() {
    ...
    var animatedElements = document.querySelectorAll('[data-animate], .fade-in, .animate-on-scroll');
        ...
        function handleScrollAnimations() {
            animatedElements.forEach(function(el) {
                if (isInViewport(el, 80) && !el.classList.contains('animated')) {
                    el.classList.add('animated', 'fade-in-visible');
                }
            });
        }
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '70ddf4a3-2eda-44e5-94a1-8cccf3f12cb8',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '70ddf4a3-2eda-44e5-94a1-8cccf3f12cb8';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '70ddf4a3-2eda-44e5-94a1-8cccf3f12cb8';
